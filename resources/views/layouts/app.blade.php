        ...
        @else
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item text-warning" href="{{ route('admin.dashboard') }}"><i class="bi bi-shield-lock me-2"></i>Admin Panel</a></li>
                    @endif
...
<aside id="appSidebar">
    ...
    <div class="sidebar-user">
        ...
        <div>
            <div class="fw-semibold text-light" style="font-size:.82rem">{{ auth()->user()->name }}</div>
...
<div class="app-wrapper">
    ...
    <footer class="app-footer">&copy; {{ date('Y') }} TravelApp. All rights reserved.</footer>
</div>
