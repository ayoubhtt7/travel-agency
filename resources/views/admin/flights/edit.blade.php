        ...
        <div class="row g-3 mb-3">
            <div class="col-md-3">
                ...
                <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                    <option value="aller_simple" {{ old('type', $flight->type) == 'aller_simple' ? 'selected' : '' }}>One Way</option>
                    <option value="aller_retour" {{ old('type', $flight->type) == 'aller_retour' ? 'selected' : '' }}>Round Trip</option>
                    <option value="direct"       {{ old('type', $flight->type) == 'direct'       ? 'selected' : '' }}>Direct</option>
                </select>
            ...
            <div class="col-md-3">
                ...
                <select name="class" class="form-select @error('class') is-invalid @enderror" required>
                    <option value="economique"  {{ old('class', $flight->class) == 'economique'  ? 'selected' : '' }}>Economy</option>
                    <option value="eco_premium" {{ old('class', $flight->class) == 'eco_premium' ? 'selected' : '' }}>Premium Economy</option>
                    <option value="affaires"    {{ old('class', $flight->class) == 'affaires'    ? 'selected' : '' }}>Business</option>
                    <option value="premiere"    {{ old('class', $flight->class) == 'premiere'    ? 'selected' : '' }}>First Class</option>
                </select>
            ...
            <div class="col-md-3">
                ...
                <input type="number" name="available_seats"
                       ...
                       value="{{ old('available_seats', $flight->available_seats) }}" min="0" required>
            ...
            <div class="col-md-3">
                ...
                <input type="number" name="price"
                       ...
                       value="{{ old('price', $flight->price) }}" min="0" step="0.01" required>
            ...
            <div class="col-md-6">
                <div class="form-check form-switch mt-2">
                    <input class="form-check-input" type="checkbox" name="with_baggage"
                           value="1" id="withBaggage"
                           {{ old('with_baggage', $flight->with_baggage) ? 'checked' : '' }}>
                    <label class="form-check-label fw-semibold" for="withBaggage">🧳 Baggage Included</label>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-check form-switch mt-2">
                    ...
                    <label class="form-check-label fw-semibold" for="isDirect">✈ Direct Flight</label>
                </div>
            </div>
        </div>
