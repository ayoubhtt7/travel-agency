...
<div class="container py-4">
    ...
    <div class="search-summary mb-4">
        <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <span class="badge bg-primary">
                ...
                {{ $classMap[$request->class] ?? $request->class }}
            </span>
    ...
    <div class="alert alert-info">
        No flights available for this search. <a href="{{ route('flights.index') }}">Modify your search</a>.
    </div>
    @endforelse
            ...
            <div class="col-md-2 text-center">
                ...
                <div class="mt-2">
                    ...
                    <form action="{{ route('flights.passengers') }}" method="GET">
                        ...
                        <button class="btn btn-success btn-sm w-100">Select Round Trip →</button>
                    </form>
                    @else
                    <a href="{{ route('login') }}" class="btn btn-outline-primary btn-sm w-100">Login to Book</a>
                    @endauth
    ...
    <div class="alert alert-warning mt-3">No return flights available for the selected date.</div>
    @endif
